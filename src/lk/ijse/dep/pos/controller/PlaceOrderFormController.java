...
public class PlaceOrderFormController {
    ...
    public void btnPlaceOrder_OnAction(ActionEvent actionEvent) {
        ...
        try {
            ...
            //JasperReport jasperReport = (JasperReport) JRLoader.loadObject(this.getClass().getResourceAsStream("/lk/ijse/dep/pos/report/MainBill.jasper"));
            Map<String, Object> params = new HashMap<>();
            params.put("image", this.getClass().getResource("/lk/ijse/dep/pos/images/orders.png").getFile());
