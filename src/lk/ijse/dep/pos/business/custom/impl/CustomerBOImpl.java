...
import lk.ijse.dep.pos.business.exception.AlreadyExistsException;
...
public class CustomerBOImpl implements CustomerBO {
    ...
    public void deleteCustomer(String customerId) throws Exception {
        ...
        if (orderDAO.existByCustomerId(customerId)) {
            throw new AlreadyExistsException("Customer already exists in an order hence unable to delete");
        }
